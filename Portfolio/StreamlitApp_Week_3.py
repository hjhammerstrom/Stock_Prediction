...
MODEL_INFO = {
        ...
        "keys": ["AAPL", "ABNB","BLK", "DEXUSEU", "DEXCHUS", "NASDAQCOM", "DGS10", "DCOILWTICO"],
        "inputs": [{"name": k, "type": "number", "min": -1.0, "max": 1.0, "default": 0.0, "step": 0.01} for k in ["AAPL", "ABNB","BLK", "DEXUSEU", "DEXCHUS", "NASDAQCOM", "DGS10", "DCOILWTICO"]]
}
